...
export const siteConfig = {
  brandName: '바름공간',
  phoneNumber: '010-8264-0975',
  consultationUrl: 'https://open.kakao.com/o/sP3eGghg',
  businessInformation: '바름공간 | 대표: 송진오 | 사업자등록번호: 247-03-02484 | 주소: 서울시 강서구 화곡본동 106-25',
...
export const siteImages = {
  hero: null,
  elasticBefore: '/closet_before.png',
  elasticAfter: '/closet_after.png',
